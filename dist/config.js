...
exports.themeManager = exports.THEME_COLORS = exports.DEFAULT_WHITEBOARD_CONTAINER = exports.DEFAULT_MINDMAP_CONTAINER = void 0;
exports.applyContainerConfig = applyContainerConfig;
exports.DEFAULT_MINDMAP_CONTAINER = {
    width: '100%',
    height: '600px',
    minWidth: '400px',
    minHeight: '400px',
...
exports.DEFAULT_WHITEBOARD_CONTAINER = {
    width: '100%',
    height: '600px',
    minWidth: '400px',
    minHeight: '400px',
...
class ThemeManager {
    ...
    applyTheme(theme) {
        ...
        const themeColors = exports.THEME_COLORS[theme];
...
function applyContainerConfig(element, config = exports.DEFAULT_MINDMAP_CONTAINER) {
