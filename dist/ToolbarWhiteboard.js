...
function createWhiteboardToolbar(wb) {
    ...
    function makeIconBtn(icon, aria, action) {
    ...
    // Add Text item
    toolbar.append(makeIconBtn(textIcon, "Add Text", () => {
        wb.board.addItem({ type: "text", x: 20, y: 20, width: 120, height: 30, content: "New Text" });
    }));
    // Add Sticky note
    toolbar.append(makeIconBtn(stickyIcon, "Add Sticky Note", () => {
    ...
    // Clear all items
    toolbar.append(makeIconBtn(clearIcon, "Clear All", () => {
        wb.board.fromJSON('{"items":[]}');
    }));
    // Export PNG
    toolbar.append(makeIconBtn(exportIcon, "Export PNG", async () => {
    ...
    // Copy JSON
    toolbar.append(makeIconBtn(copyIcon, "Copy JSON", () => {
