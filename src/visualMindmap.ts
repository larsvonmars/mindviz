...
class VisualMindMap {
  ...
  private drawCustomConnection(source: MindNode, target: MindNode, connection: MindMapConnection): void {
    ...
    line.setAttribute("x1", ((source as any).x).toString());
    line.setAttribute("y1", ((source as any).y).toString());
    line.setAttribute("x2", ((target as any).x).toString());
    line.setAttribute("y2", ((target as any).y).toString());
    ...
    if (connection.label) {
      ...
      const midX = (((source as any).x + (target as any).x) / 2).toString();
      const midY = (((source as any).y + (target as any).y) / 2).toString();
